...
$ComboBox1.Add_SelectedIndexChanged({
        $local:RooPathList = @("D:\Drop_Watm", "D:\Drop_LandBankMS", "D:\Drop_Landbank")
        $local:HoldPathList = @("D:\Drop_Watm\Hold_WatmSource", "D:\Drop_LandBankMS\Hold_LandBankMS_Source", "D:\Drop_Landbank\Hold_LandBank_Source")
